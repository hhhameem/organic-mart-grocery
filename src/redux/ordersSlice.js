...
export const addNewOrder = createAsyncThunk(
    'orders/addOrder',
    async (newOrder) => {
        const response = await fetch('https://sheltered-caverns-74517.herokuapp.com/order', {
            method: 'POST',
            headers: {
...
export const fetchOrders = createAsyncThunk("orders/fetchOrders", async () => {
    ...
    return await axios.get("https://polar-savannah-40370.herokuapp.com/dashboard/orders")
...
export const deleteOrder = createAsyncThunk(
    'orders/deleteOrder',
    async (id) => {
        return await fetch(`https://polar-savannah-40370.herokuapp.com/dashboard/orders/${id}`, {
            method: 'DELETE'
        }).then(res => res.json())
            .then(data => {
